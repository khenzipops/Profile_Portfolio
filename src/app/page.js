...
export default function Home() {
  return (
    <div id="/">
      <Navbar />
      <div className="relative text-center mt-60 h-96 md:h-96 sm:h-72">
      ...
      <div id="bio" className="bg-secondaryColor p-3">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-[25%_75%] gap-2 w-full h-auto p-6 bg-secondaryColor">
