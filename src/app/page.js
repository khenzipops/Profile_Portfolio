...
export default function Home() {
  return (
    <div>
      <Navbar />
      <div id="home" className="relative text-center mt-60 bg-cover bg-center h-screen">
        ...
        <h1 className="font-roboto font-medium text-xl md:text-2xl mb-60 text-black z-10">FRONTEND DEVELOPER</h1>
      </div>

      {/* Start ME */}
      <div id="bio" className="bg-secondaryColor p-3">
        <h1 className="text-3xl border-l-4 border-mainColor p-2 font-roboto font-semibold">ME</h1>
      ...
      <div id="project" className="mt-4 md:mt-8">
        <h1 className="text-3xl border-l-4 border-mainColor p-2 font-roboto font-semibold ml-3">PROJECT</h1>
      ...
      <div className="bg-secondaryColor  p-3">
        <h1 className="text-3xl border-l-4 border-mainColor  font-roboto font-semibold p-2 mb-2">TECHNICAL SKILL</h1>
        <div className="p-4 ">
          <TechnicalSkills />
        </div>
      </div>
      ...
      {/* CONTACT US */}
      <div className=" p-3  ">
        <h1 className="text-3xl border-l-4 border-mainColor p-2 font-roboto font-semibold">CONTACT</h1>
